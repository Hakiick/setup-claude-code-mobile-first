...
4. **Mobile-first** — Vérifie que l'architecture supporte les contraintes mobile (performance, touch, viewport)
5. **Risques** — Identifie les dépendances, edge cases, et régressions possibles
